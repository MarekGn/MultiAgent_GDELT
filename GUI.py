...
class Window(QDialog):
    ...
    def create_start_year_hboxlayout(self):
        ...
        self.start_year_label = QLabel("The beginning year")
    ...
    def create_stop_year_hboxlayout(self):
        ...
        self.stop_year_label = QLabel("The end year")
    ...
    def create_most_common_countries_hboxlayout(self):
        ...
        self.most_common_countries_label = QLabel("The amount of countries in final results")
    ...
    def create_country_code_hboxlayout(self):
        ...
        self.country_code_label = QLabel("Considered country")
